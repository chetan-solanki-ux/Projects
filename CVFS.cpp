...
void man(char *name)
{
	...
	{
		printf("Descrption :Used to write in regular file:\n");
		printf("Usage:Write File_name\n After this enter the data what you want to write:\n");
	}
	else if(strcmp(name,"ls")==0)
	{
		printf("Description:Used to Display list all information of file:\n");
		printf("Usage:ls\n");
	}
	else if(strcmp(name,"stat")==0)
	{
		printf("Description:Used to Display information of File using name\n");
		printf("Usage:stat File_name\n");
	}
	else if(strcmp(name,"fstat")==0)
	{
		printf("Description :Used to display information of File using Descipter\n");
	...
	{
		printf("Description :open exitig File\n");
	...
	else if(strcmp(name,"lseek")==0)
	{
		...
		printf("Usage:lseek File_name Change OffSet StartPoint\n");
	}
...
void DisplayHelp()
{
	...
	printf("fstat:To Desplay all information of file using descripter\n");
	...
	while(1)
	{
		...
		else if(count==3)
		{
			if(strcmp(command[0],"create")==0)
			{
				...
				if(ret==-3)
					printf("ERROR:File alreday exists\n");
				if(ret==-4)
